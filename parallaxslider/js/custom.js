...
/*==========================*/
    ...
    jQuery('.align-center a, .caption-inside a, .video-section a').click(function(){
...
/*----------------------------------------------------*/
    ...
    function parallaxInit() {
        jQuery('.more-wrap').parallax("30%", 0.1);
        jQuery('.fun-wrap').parallax("30%", 0.1);
        jQuery('.testimonial-wrap').parallax("30%", 0.1);
        jQuery('.quote-wrap').parallax("30%", 0.1);
        jQuery('.subscription-wrap').parallax("30%", 0.1);
        jQuery('.image-parallax').parallax("30%", 0.1);
		jQuery('.footer-social-section').parallax("30%", 0.1);
